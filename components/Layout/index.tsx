              ...
              >
                <div className="space-x-2">
                  ...
                  <button
                    ...
                    className="relative focus:outline-none"
                  >
                    <div className="absolute top-0 left-0 inline-flex items-center justify-center w-6 h-6 transition-all duration-200 transform scale-110 rounded-full shadow-sm">
                      <svg
                        //x-show="!isDark"
                        className="w-4 h-4"
                        xmlns="http://www.w3.org/2000/svg"
